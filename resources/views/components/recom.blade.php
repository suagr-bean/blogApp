...
<div id="getTitle" class="mt-5 js-card mt-20 " >
    ...
    <form id ="show-form"method="get" action='/'>
    <button id="show-name" class="w-10 h-6 border ml-25 mt-0 rounded-lg bg-orange-300/15" >{{$data->name}}</button>
</form>
    <p id="show-content" class="ml-4 w-53 h-73 mt-3 line-clamp-10 whitespace-normal">
        {!!nl2br(e($data->content))!!}
    </p>
    </div>
  
    <x-ContentButton class="fixed top-[60vh] left-[65vw]"/>
</div>
